...
public class UserServiceImpl implements UserService {
   ...
   // @Cacheable(value = "user",key = "#name")
    ...
    @Override
    public List<User> findByNameLike(String name1) {
        return userRepository.findUser(name1);
    }

    @Override
    public List<User> getDeveloperList(String role) {
        return userRepository.findDeveloper(role);
    }
